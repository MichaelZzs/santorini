...
class Space(object):
    ...
    def __str__(self):
        print(self.row, self.col, self.occupant, self.level)
...
class PlayGame(object):
    ...
    def _initialize_workers(self):
        ...
        for worker in workers:
            ...
            new_row = int(input('Please enter new row: '))
            new_col = int(input('Please enter new col: '))
            try:
...
while not test_game.finished_game:
    ...
    current_row = int(input('row of current worker?: '))
    current_col = int(input('col of current worker?: '))
    ...
    destination_row = int(input('row of destination: '))
    destination_col = int(input('col of destination: '))
    ...
    build_row = int(input('row to build on: '))
    build_col = int(input('col to build on: '))
    try:
